...
public class Config {
    ...
    public static BooleanEntry steelModule = modulesCategory.register("steel", new BooleanEntry(true))
            .setComment("Adds steel as a resource in between iron and diamonds");
    ...
    @Comment(value = "Miscellaneous content. Includes a recipe for chainmail armor using chain plates and a block that shoots you across your world")
    ...
    @Comment(value = "Adds a new plant that can be used to farm strings and its' seeds")
